...
public class AcmeShopContextFactory : IDesignTimeDbContextFactory<AcmeShopContext>
{
    public AcmeShopContext CreateDbContext(string[] args)
    {
        var config = new ConfigurationBuilder()
               ...
               .AddUserSecrets<AcmeShopContextFactory>()
               .AddEnvironmentVariables()
               .Build();

        var builder = new DbContextOptionsBuilder<AcmeShopContext>();
        builder.UseSqlServer(config.GetConnectionString("AcmeShopContext"));
        return new AcmeShopContext(builder.Options);
    }
}
----
