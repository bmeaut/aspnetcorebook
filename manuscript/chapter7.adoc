...
WARNING: Mivel a csomag 7.x.x verziói függőségként megkövetelik a .NET 7-et, válasszuk a 6.0.13 verziót, mely kompatibilis a .NET 6-tal.

PMC-ben telepítsük az ASP.NET Core kódgeneráló eszközt

WARNING: A parancs a kódgeneráló eszköz legfrissebb verzióját telepíti, azonban a 7.x.x verzióktól kezdve az eszköz már nem kompatibilis a .NET 6-tal. Emiatt válasszuk a 6.0.13 verziót, a parancs végére helyezzük el a `--version 6.0.13` kapcsolót.
