...
WARNING: A Blazor WebAssembly az MSAL JavaScript verzióját használja (MSAL.js), azonban ennek https://github.com/dotnet/aspnetcore/issues/38122[sem minden funkcióját teszi elérhetővé]. Emiatt több B2C-s beépített user flow https://github.com/dotnet/aspnetcore/issues/27549[sem használható] (egyszerűen) Blazor WebAssembly-ből (például profilszerkesztés).
