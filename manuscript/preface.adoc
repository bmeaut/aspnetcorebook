...
* https://visualstudio.microsoft.com/downloads/[Visual Studio 2019 v16.8+] (az ingyenes Community verzió elég) az alábbi _workload_-okkal:
 ** .NET desktop development
 ** Data storage and processing
 ** .NET Core cross-platform development 
// Üzenet a jövőből: VS 2022-től nincsen .NET Core workload.
...
WARNING: A JSON formátum alapértelmezésben (a szabvány szerint) nem támogatja a kommenteket, így ha JSON kódrészletet másolunk, győződjünk meg arról, hogy nem maradt-e a beillesztett kódban komment, mert problémát okozhat.