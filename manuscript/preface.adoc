...
== Kódrészletek kimásolása

A kódrészletek sorszámozással vannak ellátva, ez pedig kimásoláskor gondot okozhat. Ilyenkor alkalmazhatjuk a blokk jellegű kijelölést, amit a legtöbb olvasóalkalmazás támogat, leggyakrabban az _[ALT]_ billentyű kijelölés alatti folyamatos nyomvatartásával. Blokk alapú kijelöléssel kijelölhetjük csak a kódrészletet a sorszámok nélkül.
