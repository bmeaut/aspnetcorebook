...
** az *[U2]UpdateTej* hívásban a **Pre-request Script*  fülön helyen, a *Body* fülön egy helyen, illetve a *Params* fülön egy helyen
...
Az elkészült teljes Postman kollekció importálható https://www.getpostman.com/collections/ae74016ec0be4a7da277[erről a linkről] az OpenAPI importáláshoz hasonló módon.
