...
Migrálnunk kell, mert megjelent egy új mező a `Product` táblánkban. Ne felejtsük el a szokásos módon beállítani _Default Projectet_ a DAL-ra a _Package Manager Console_-ban!
