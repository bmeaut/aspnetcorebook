...
A gyakorlat kezdetén töltsük le a [kiinduló projektet](https://github.com/bmeaut/dotnet/archive/refs/heads/master.zip) zip-ként. Miután kitömörítettük a fájlokat, töltsük be Visual Studio-ba a _HelloLinq_ mappából a _HelloLinq.sln_ solution fájlt.
